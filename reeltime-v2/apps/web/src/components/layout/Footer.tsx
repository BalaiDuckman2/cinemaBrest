      ...
      <div className="container mx-auto px-3 sm:px-4 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4 sm:gap-6 mb-6 text-sm">
          <a
            ...
            className="font-crimson text-or-antique hover:text-jaune-marquise transition flex items-center gap-1.5 underline"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="font-crimson text-or-antique hover:text-jaune-marquise transition underline"
          >
            Données AlloCiné
          </a>
        </div>
